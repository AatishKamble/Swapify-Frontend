  ...
  <div class="mx-auto max-w-screen-xl  px-4 py-8 sm:px-6 lg:space-y-16 ">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        <img src="../../src/assets/logo.png" alt="logo" className=' object-cover h-20 w-36' />
      ...
      <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
        <div>
          ...
          <ul class="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" class="text-gray-700 transition hover:opacity-75">  </a>
            </li>

            <li>
              <a href="#" class="text-gray-700 transition hover:opacity-75">collections</a>
            </li>


            <li>
              <a href="#" class="text-gray-700 transition hover:opacity-75"> Categories </a>
            </li>
    ...
    <p class="text-xs text-gray-500">&copy; 2024. Swapify. All rights reserved.</p>
  </div>
</footer>
